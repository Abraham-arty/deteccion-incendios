"""
DETECTOR DE ANOMALÍAS CON SUPABASE - VERSIÓN CLOUD
==================================================
Detecta incendios en tiempo real y guarda en Supabase.
"""
...
# ============================================
# DETECTOR GLOBAL CON SUPABASE
# ============================================
class GlobalFireDetectorSupabase:
    ...
    def _periodic_flush(self):
        while self.running:
            ...
            count = self.db.flush_readings()
            if count > 0:
                print(f"💾 {count} lecturas guardadas en Supabase")
...
# CLIENTE MQTT
# ============================================
class MQTTFireDetectorSupabase:
    def __init__(self):
    ...
    def setup(self):
        ...
        self.detector = GlobalFireDetectorSupabase(self.db)
    ...
    def _display_fire(self, fire):
        ...
        print(f"💾 ID Supabase: {fire.get('incident_id', 'N/A')}")
    ...
    def _display_stats(self):
        ...
        print(f"☁️ Supabase: {stats.get('total_readings_db', 0)} lecturas, "
...
def main():
    print("""
    ╔═══════════════════════════════════════════════════════╗
    ║   DETECTOR DE INCENDIOS CON SUPABASE - v2.5          ║
    ║                                                       ║
    ║   🌲 Isolation Forest (entrena rápido)               ║
    ║   ☁️ Guarda en Supabase (cloud database)            ║
    ║   🔥 Detecta incendios en tiempo real                ║
    ╚═══════════════════════════════════════════════════════╝
    """)
    
    detector = MQTTFireDetectorSupabase()
